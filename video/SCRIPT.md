...
| 22–28 | **More room. More control.** / Outline. Search. Your reading style. | Match-cut real native Folio screenshots: reader with outline, active search, then cycle through the VS Code preset with blue tint and the iA Writer preset with amber tint. Appearance controls show the active preset and swatch; captions name each combination. Each preset holds for about 1.5 seconds. |
