...
if(count!==1260) throw new Error(`Expected the 42-second film's 1260 frames; decoded ${count}.`);
...
const holds=[[0,35],[97,119],[270,479],[542,659],[685,704],[716,749],[765,794],[806,839],[865,891],[928,954],[981,1079],[1091,1259]];
