...
function FolioSocial() {
  return <AbsoluteFill style={{background:'#19181f', color:'#f5f3f8', fontFamily:sans, overflow:'hidden'}}>
    ...
    <div style={{position:'absolute', left:61, top:109, display:'flex', alignItems:'center', gap:19}}>
      ...
      <div style={{fontFamily:serif, fontSize:96, fontWeight:600, letterSpacing:-5, lineHeight:1.1}}>folio<span style={{color:'#b79bd6'}}>.</span></div>
    </div>
    ...
    <div style={{position:'absolute', left:709, top:55, width:503, height:497, borderRadius:15, overflow:'hidden', boxShadow:'0 22px 60px #0008', border:'1px solid #ffffff55', background:'#fff'}}>
      <Img src={staticFile('screenshots/workflow-quicklook.png')} style={{display:'block', width:'100%', height:'100%', objectFit:'contain'}}/>
    </div>
...
registerRoot(() => <Composition id="FolioSocial" component={FolioSocial} durationInFrames={1} fps={30} width={1280} height={640}/>);
